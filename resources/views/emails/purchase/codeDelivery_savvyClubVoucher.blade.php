...
# Congratulations!<br><br>Your free Savvy Premium Horsenality&reg; Voucher is here!

@component('mail::panel')

@if($order->claimed)
Thank you for being a Savvy Club Premium member! As one of your membership benefits, you are being given one FREE Horsenality&reg; report voucher. Your report has been delivered to your Horsenality&reg; account automatically and is ready to use!<br><br>
<strong>Your Login:</strong> {{ $order->purchase_email }}
@else
Thank you for being a Savvy Club Premium member! As one of your membership benefits, you are being given one FREE Horsenality&reg; report voucher.<br><br>
...
That's okay! You might have used a different email address for your Savvy Club than your Horsenality&reg; profile, or you may not have created a Horsenality&reg; profile yet.<br><br>
