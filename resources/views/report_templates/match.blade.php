...
<link href="{{ url('/') . '/css/match-pdf.css' }}" rel="stylesheet" type="text/css" />
	...
	<div class="container-fluid my-5">
						...
						<tbody>
							<tr>
								<td class="w-50 paragraph-spacing">
									<div>Welcome to your Humanality Report, Section 1 of the Parelli Horsenality/Humanality/Match System.</div>
    				...
    				<div class="row my-5">
    					<div class="w-100">
    						<div class="my-3 text-muted">You are in for some interesting and
    							...
    							we see the development of people and horses.</div>
    						<div class="my-3 text-muted">We will be back with you at the end
    							for the transition into Section 2, where your Humanality results
    							get paired with {{$template->horsename}}'s Horsenality. Prepare
    							to gain more savvy about yourself.</div>
				...
				<div class="row my-5">
					...
					<div class="w-75 text-muted paragraph-spacing">
						...
						<div>As you increase your understanding of your Humanality, you'll
							 become better prepared to look at your specific relationship
							 with your horse. This report will help you gain valuable insights
							 in understanding yourself, with others... and with {{$template->horsename}}.</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card my-5">
			...
			<div class="card-body pg-5 paragraph-spacing inner-page">
				...
				<div>These axes create four Humanality quadrants. This layout is 
					very similar to the Horsenality profile and makes it possible
					to compare the two profiles (both you and your horse). That's
					when things really get interesting!</div>
			...
			<div class="card-body">
				<div class="row">
					<div class="w-75">
						...
						<div class="my-3">Let's look more closely at the four Humanality types
							that the Parelli Profile generates. Playful caricatures and short
							descriptions reveal the general characteristics of the four types.
							You'll notice some close similarities to the Horsenality model and
							you'll spot some different twists since this is about humans rather
							than horses.</div>
					</div>
					<div class="w-25">
						<img class="w-75" alt=""
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<div class="my-3">Innate characteristics often determine your
					...
					situations.</div>
				<div class="my-3">However, what you learn sometimes modifies your innate
				...
				<div class="my-3">Unfortunately, you may also have learned some behaviors that
				...
				<div class="my-3">To avoid losing some of your strengths you need to rediscover
				...
				<div class="row my-5">
					<div class="w-75">
						...
						<div class="my-5">Learned behaviors are patterns you have adopted by observing
							and interacting with others, consciously or unconsciously.</div>
						<div class="my-3">As a small child, you initially learn from family members and
				...
				<div class="my-3">Different situations also impact a horse's behavior. A horse
					...
					a trailer. .</div>
				<div class="my-3">Situational changes are easier to notice in horses and other
				...
				<div class="my-3">For example, you may believe you are confident both in the
				...
				<div class="my-3">If you're not careful, you might blame your horse when the
					problem actually started with you.</div>
				<div class="my-3">Increasing your awareness of how different situations or
			...
			<div class="card-body">
				<div class="row my-5">
					<div class="w-75 text-danger">
						<div class="my-3">Now, get prepared for Section 2, the Match
							Report between you and your horse.</div>
						<div class="my-3">Sometimes your Humanality strengths are the things
							your horse finds the most challenging about you! For example, being
							direct or too enthusiastic can feel predatory to a horse; and at the
							other extreme, being too cautious to ask much can make a horse feel
							unsure about your capacity as a leader.</div>
...
<!--
				...
				<div class="row my-5">{!! $template->statement['[P-Cusp-Supplement]'] !!}</div>
	...
	<div class="container-fluid my-5">
		...
		<h6 class="text-right pg-1-subtitle">on {{$template->assessment_date_formatted}}</h6>
			...
			<div class="card-body">
				<div class="row">
					<div class="w-50">
						<h3 class="my-3">Dear {!! $template->firstNameR !!},</h3>
						<div class="my-3">Welcome to Section 2, your Parelli Match Report.
						</div>
						<div class="my-3">This is where things get really interesting,
							profoundly revealing, and practically helpful. Your Humanality
							profile is matched with {!! $template->horsename !!}'s Horsenality and your
							similarities and differences are compared. You're going to
							explore the dynamics that play out between you and {!! $template->horsename !!}.
						</div>
					</div>
				...
				<div class="card-body">
    				<div class="row my-5">
    					<div class="w-100">
    						<div class="my-3 text-muted">As you know, your behavior can bring out
        						...
        						your behavior so you become the leader {!! $template->horsename !!} needs and
        						bring out the best in {{ $template->pronoun['him-her-H'] }}. However, you must start by
        						learning how the basic match between the core you aligns with
        						{!! $template->horsename !!}'s core traits. This gives you a starting point to
        						work from and reference point to build the right training program
        						for {!! $template->horsename !!} ...and for you!</div>
    						<div class="my-3 text-muted">That's why the richness of the online Horsenality
        						System really comes out in this section; a comparison of your
        						Humanality to {!! $template->horsename !!}'s Horsenality. We're going to go along
    						...
    						<div class="my-3 text-muted">Prepare to get SAVVY about the match between your
								HUMANALITY and {!! $template->horsename !!}'s HORSENALITY!</div>
    						<div class="my-3 text-muted">Naturally,</div>
    						<div class="my-3 text-muted">
    							<img alt=""
    								src="{!!asset('assets/reports/temps/humanality/Background (28).png')!!}">
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<p>The Match between You and {!! $template->horsename !!}</p>
		...
		<div class="card my-5">
			<div class="card-header bg-secondary text-white fs-3 fw-bloder">The
				Match Between You and {!! $template->horsename !!}</div>
			<div class="card-body">
				<div class="my-3">The chart on the left plots your Humanality score.
					The chart on the right is {!! $template->horsename !!}'s Horsenality. We're going
					to compare and contrast these in this Match Report. Let's get
					going!</div>
				<div class="row my-5">
					<div class="w-50 text-center">
						<h3 class="my-3">{!! $template->firstNameR !!}'s</h3>
						<h3 class="my-3">HUMANALITY</h3>
						<div class="my-3"><img class="w-95" alt="" src="{{ $template->graph['Personality-Overall-Rating-Graph']['path'] }}"></div>
					</div>
					<div class="w-50 text-center">
						<h3 class="my-3">{!! $template->horsename !!}'s</h3>
						<h3 class="my-3">HORSENALITY</h3>
						<div class="my-3"><img class="w-95" alt="" src="{{ $template->graph['Horsenality-Overall-Rating-Graph']['path'] }}"></div>
					</div>
				</div>
				<div class="row my-5">
					<div class="w-75">
						<h3 class="my-3">Overview</h3>
						<div class="my-3">{!! $template->statement['[M-Overview]'] !!}</div>
					</div>
					<div class="w-25">
						<img alt="" class="w-75"
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<div>
            		<img class="w-100" alt="" src="{{ $template->graph['Match-Interaction-Pattern-Graph']['path'] }}">
            	</div>
				<div class="row my-5">
					<div class="w-75">
						<div class="my-3">{!! $template->statement['[M-Interaction]'] !!}</div>
					</div>
					<div class="w-25">
						<img alt="" class="w-75"
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<h3 class="my-3">Similarities and differences between
					{!! $template->firstNameR !!} and {!! $template->horsename !!}:</h3>

				<div class="row my-5">
					<div class="w-50 text-center">
						<h3 class="my-3">HUMANALITY</h3>
						<div class="my-3">{!! $template->statement['[P-Cartoon]'] !!}</div>
						<div class="my-3">{!! $template->firstNameR !!}</div>
						<div class="my-3">{!! $template->statement['[P-Quadrant]'] !!}</div>
					</div>
					<div class="w-50 text-center">
						<h3 class="my-3">HORSENALITY</h3>
						<div class="my-3">{!! $template->statement['[H-Cartoon]'] !!}</div>
						<div class="my-3">{!! $template->horsename !!}</div>
						<div class="my-3">{!! $template->statement['[H-Quadrant]'] !!}</div>
					</div>
				</div>

				<div class="row my-5">{!! $template->statement['[M-Table-Compare]'] !!}</div>
			</div>
		</div>
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<h3 class="my-3">Here are some predictable relationship dynamics and
					challenges you'll have with {!! $template->horsename !!}.</h3>

				<div class="row my-5">{!! $template->statement['[M-Dynamics]'] !!}</div>
			</div>
		</div>
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<div class="row my-5">
					<div class="w-50">
						<div class="my-3">Your horse can only be as calm or
						...
						<div class="my-3">When in Horseville, do as horses do.
						</div>
					</div>
					<div class="w-50">
				...
				<h3 class="my-3">Things that challenge you around {!! $template->horsename !!}:</h3>

				<div class="row my-5">{!! $template->statement['[M-Challenges]'] !!}</div>
			</div>
		</div>
		...
		<div class="card my-5">
			<div class="card-header bg-secondary text-white fs-3 fw-bloder">Partnership
				Strategies</div>
			<div class="card-body">
				<div class="my-3">Strategies for Partnering with {!! $template->horsename !!}</div>
				...
				<div class="row my-5">{!! $template->statement['[M-Ground]'] !!}</div>
				...
				<div class="row my-5">
					<div class="w-50">
						<div class="my-3 text-muted">Riding takes both you and
							{!! $template->horsename !!} into a completely different dimension. You'll
							notice new behavior patterns in {{ $template->pronoun['him-her-H'] }} and {!! $template->horsename !!}
				...
				<div class="row my-5">{!! $template->statement['[M-Riding]'] !!}</div>
			</div>
		</div>
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<h3 class="my-3">Advanced Partnership Strategies with {!! $template->horsename !!}</h3>

				<div class="row my-5">
					<div class="w-50">
						<div class="my-3 text-muted">As you and {!! $template->horsename !!} advance in
							your partnership and stretch your performance level, you may
							inadvertently push {!! $template->horsename !!} too hard and bring out some
				...
				<div class="row my-5">{!! $template->statement['[M-Partnership]'] !!}</div>
			</div>
		</div>
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<div class="my-3">Now let's look at some specific behaviors that you
					sometimes demonstrate around {!! $template->horsename !!} particularly when you're
					...
					and {!! $template->horsename !!}.</div>
					
				<div>
            		<img class="w-100" alt="" src="{{ $template->graph['Personality-Detail-Rating-Graph']['path'] }}">
            	</div>
				...
				<div class="row my-5">
					<div class="w-75">
						<div class="my-3 text-muted">One of my mentors, Ronnie Willis,
							...
							behaviors related specifically to {!! $template->horsename !!}'s needs and to
							bring out the best in {{ $template->pronoun['him-her-H'] }}. In the next section, I will
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<div class="row my-5">
					<div class="w-75">
						<div class="my-3 text-muted">A major goal is to move your extreme
							...
							but it also makes {!! $template->horsename !!} less stressed and easier to teach
							and manage.</div>
				...
				<div class="row my-5">
                @foreach($template->statement['[P-Stress-Behaviors]'] as $behavior)
					{!! $behavior !!}
                @endforeach				
				</div>
			</div>
		...
		<div class="card my-5">
			...
			<div class="card-body">
				<div class="rwo my-5">All human/horse matchups have their highlights
					...
					horse.</div>
				<div class="rwo my-5">
                	<img class="w-50" alt="" src="{{ $template->graph['Match-Interaction-Pattern-Graph']['path'] }}">
				</div>
				<div class="row my-5">
					<div class="w-75">
						<div class="my-3 text-muted">Here's what you'll grow to appreciate
							in {!! $template->horsename !!}</div>
						<div class="my-3">{!! $template->statement['[M-Summary]'] !!}</div>
					</div>
					<div class="w-25">
						<img class="w-100 mw-75 min-w-25"
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<div class="row my-5">
					<div class="w-75">
						<h3>{!! $template->horsename !!}'s Name Plaque</h3>
						<div class="my-3 text-muted">Consider putting {!! $template->horsename !!}'s
							profile chart on {{ $template->pronoun['him-her-H'] }} stall door or feeding bin. This
							gives you a reminder of {{ $template->pronoun['him-her-H'] }} primary Horsenality traits.
						</div>
						<div class="my-3 text-muted">A visible plaque also helps generate
							...
							strategies for training and playing with {!! $template->horsename !!}.</div>
		...
		<div class="card my-5">
			<div class="card-body text-center">
				<div class="plaque-background">{!! $template->statement['[H-Plaque]'] !!}</div>
				<div class="plaque-overlay-top">
					<h3>{!! $template->horsename !!}'s</h3>
					<h3>HORSENALITY</h3>
					...
					<div class="plaque-overlay-bottom text-center">
						<div>{!! $template->statement['[H-Tendencies]'] !!}</div>
					</div>
				</div>
			</div>
		</div>
