...
<body class="fs-4">
	<div class="container-fluid my-5">
		...
		<h1 class=text-center>For {!!$template->firstNameR!!}</h1>
		<h6 class="card-subtitle mb-2 text-muted text-center">Completed by {!!$template->firstNameE!!} 
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<div class="fw-bolder">The vertical (up and down) axis on the chart
					measures:</div>
				<div>EXTROVERT (how outgoing, animated, and expressive you are)</div>
				<div>INTROVERT (how reserved, quiet, and non-demonstrative you are)</div>

				<div class="fw-bolder">The horizontal (left and right) axis on the
					chart measures:</div>
				<div>LEFT-BRAIN (how confident, candid, and dominant you are)</div>
				<div>RIGHT-BRAIN (how indirect, emotional, and cautious you are)</div>
			...
			<div class="card-body">
				<div class="row">
					<div class="w-75">
						...
						<div>Let's look more closely at the four Humanality types that the
		...
		<div class="card my-5">
			...
			<div class="card-body">
				...
				<h3 class="my-4">{!!$template->firstNameR!!}'S FEEDBACK WORKSHEET</h3>
			...
			<div class="card-body">
				<div class="row my-5">
					<div class="w-75">
						...
						<div>You can also help others understand you by posting your
							Humanality profile in a visible place. Consider your workplace,
							bedroom door, home office, school locker, etc.</div>
						<div>This will grab the attention of others and encourage work
				...
				<div class="row my-5">
					<div class="w-75">
						...
						<div>Fold the tent card sheet so that it stands up on its own. You
		...
		<div class="card my-5">
			<div class="card-body text-center">
				<div>MERGEFIELD [P-PLAQUE] {!!$template->P_PLAQUE!!}</div>
				<h3>MERGEFIELD</h3>
				<h3>{!!$template->firstNameR!!}</h3>
		...
		<div class="card my-5">
			<div class="card-body">
				<form action="" target="_blank"
					method="post">
					@csrf <input type="hidden" name="report_id"
						value="{!!$template->report_id!!}">
