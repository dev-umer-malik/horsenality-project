...
<body class="fs-4">
	<div class="d-none page-info" 
		horse-name="{{$template->horse_name}}"
		he-she-H="{{($template->gender == 'mare')?'she':'he'}}"
		He-She-U-H="{{($template->gender == 'mare')?'She':'he'}}"
		him-her-H="{{($template->gender == 'mare')?'her':'him'}}"
		his-her-H="{{($template->gender == 'mare')?'her':'his'}}"
		himself-herself-H="{{($template->gender == 'mare')?'herself':'himself'}}"
		His-Her-U-H="{{($template->gender == 'mare')?'Her':'His'}}" 
		></div>
	...
	<div class="container-fluid my-5">
		...
		<div class="card my-5">
			<div class="card-body">
				<form action="{!!route('test_portal.reports.save')!!}" target="_blank"  method="post">
					@csrf
					<input type="hidden" name="report_id" value="{!!$template->report_id!!}">
	...
	document.addEventListener('DOMContentLoaded', (event) => {
		...
		var he_she_H =  document.querySelector('.page-info').getAttribute('he-she-H')
		var Horsename =  document.querySelector('.page-info').getAttribute('Horsename')
		var He_She_U_H =  document.querySelector('.page-info').getAttribute('He-She-U-H')
		var him_her_H =  document.querySelector('.page-info').getAttribute('him-her-H')
		var his_her_H =  document.querySelector('.page-info').getAttribute('his-her-H')
		var himself_herself_H =  document.querySelector('.page-info').getAttribute('himself-herself-H')
		var His_Her_U_H =  document.querySelector('.page-info').getAttribute('His-Her-U-H')
		
    	var data = document.querySelector('body').innerHTML
    	.replaceAll('[Horsename]', Horsename)
    	.replaceAll('[he-she-H]', he_she_H)
    	.replaceAll('[He-She-U-H]', He_She_U_H)
    	.replaceAll('[him-her-H]', him_her_H)
    	.replaceAll('[his-her-H]', his_her_H)
    	.replaceAll('[himself-herself-H]', himself_herself_H)
    	.replaceAll('[His-Her-U-H]', His_Her_U_H);
