...
<body>
			...
			<tbody>
				<tr>
					<td>
						...
						<div>{!! $template->statement['[H-From-Images]'] !!}</div>
					</td>
					<td>
						<h3>to this!</h3>
						<div>{!! $template->statement['[H-To-Images]'] !!}</div>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="inner-page">
		...
		<div>
			For <strong>specific exercises,</strong> use the Patterns found inside of the Savvy Club. (More on this in the next section).
		</div>
	</div>
...
@if( isset( $template->statement['[H-Situational-Behaviors]'] ) )
		<div class="page-break"></div>
